if polyglot#init#is_disabled(expand('<sfile>:p'), 'buck', 'ftplugin/buck.vim')
  finish
endif
...
" Core settings for the buck filetype, used for BUILD and *.buck files for the
...
if get(g:, 'ft_buck_fold', 0)
  setlocal foldmethod=syntax
  setlocal foldtext=BuckFoldText()
endif

if exists('*BuckFoldText')
  let &cpo = s:save_cpo
  unlet s:save_cpo
  finish
endif

function BuckFoldText() abort
